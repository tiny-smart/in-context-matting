...
from icm.models.feature_extractor.checkpoint import ODISECheckpointer
from icm.models.feature_extractor.config import instantiate_odise
...
def get_config_file(config_path):
    ...
    cfg_file = pkg_resources.resource_filename(
        "icm.models.feature_extractor.model_zoo", os.path.join("configs", config_path)
    )
