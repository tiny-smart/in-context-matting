if __name__ == '__main__':
    ...
    def parse_args():
        ...
        parser.add_argument(
            ...
            default="in_context_matting-semitrainingattn_6data",
        )
        parser.add_argument(
            "--debug",
            type=bool,
        ...
        parser.add_argument(
            ...
            default="logs/2023-10-30_10-44-35-in_context_matting-semitrainingattn_6data/checkpoints/10-0.01130.ckpt",
        )
        parser.add_argument(
            "--fine_tune",
            type=bool,
